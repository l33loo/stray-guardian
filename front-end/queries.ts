    ...
    const pins = [
        {
            ...
            coordinate: {latitude: 37.748976654581526, longitude: -25.66777811961261},
        },
        {
            animalType: 'dog',
            listingType: 'found',
            ...
            color: 'brown',
            coordinate: {latitude: 37.750033, longitude: -25.669765},
        },
        {
            animalType: 'seagull',
            listingType: 'found',
            ...
            color: 'white',
            coordinate: {latitude: 37.747976, longitude: -25.653857},
        },
    ];
